#!/usr/bin/env python3
"""
Start Ed, Edd n Eddy upload directly
"""
...
def main():
    ...
    for root, dirs, files in os.walk(base_dir):
        for file in files:
            if file.startswith("Ed, Edd n Eddy -") and file.endswith(".mp4"):
                ...
                if len(ed_files) >= 1:  # Just get first file for testing
                    break
        if len(ed_files) >= 1:
            break
    ...
    try:
        ...
        if response[0].status_code == 200:
            ...
            print("\nReady to upload all files with:")
        ...
        print("Check your Archive.org credentials and try again.")
